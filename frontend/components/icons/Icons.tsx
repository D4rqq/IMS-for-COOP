...
export const ProductsIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const ReportsIcon: React.FC = () => (
  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V7a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
);
...
export const MenuOpenIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const MenuCloseIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const TotalRevenueIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-green-500" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1h4v1h-4zm-2 10v-1h4v1h-4z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 18h.01M12 18v-1h4v1h-4zm-2 0v-1h2v1h-2zm-2-2h.01M6 16v-1h2v1H6zm12 0h.01M18 16v-1h2v1h-2zM6 12h.01M6 12V7h2v5H6zm12 0h.01M18 12V7h2v5h-2z"></path></svg>
);

export const ItemsSoldIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-blue-500" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
);

export const LowStockIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-red-500" }) => (
...
export const DollarSignIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 1v.01"></path></svg>
);
...
export const AddStockIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
);

export const KebabMenuIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z"></path></svg>
);

export const EmptyStateIcon: React.FC<{ className?: string }> = ({ className = "w-16 h-16 text-slate-400" }) => (
    <svg className={className} stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
);
...
export const EyeOffIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7 .525-1.666 1.39-3.166 2.458-4.425m5.207 8.167a3 3 0 004.242-4.242M12 12a3 3 0 01-3-3m9.542 3c-1.274 4.057-5.064 7-9.542 7a10.05 10.05 0 01-1.875-.175M2.458 12c1.274-4.057 5.064-7 9.542-7 .847 0 1.674.114 2.47.325m1.368 1.368A10.06 10.06 0 0121.542 12M3 3l18 18"></path></svg>
);

export const WarningIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 3.001-1.742 3.001H4.42c-1.53 0-2.493-1.667-1.743-3.001l5.58-9.92zM10 13a1 1 0 110-2 1 1 0 010 2zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd"></path></svg>
);
...
export const WifiOffIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6.414 6.414a2 2 0 00-2.828 0m0 0L2 2m0 0l2 2m16 16l2 2m-2-2l-2-2m-2.828-2.828a2 2 0 002.828 0m0 0L22 22m0 0l-2-2m-12.828 0a2 2 0 002.828 0m0 0l2 2m-8.172 0a2 2 0 002.828 0m0 0l2 2"></path></svg>
);
